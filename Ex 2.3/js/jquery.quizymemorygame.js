...
(function ($) {
    ...
    var methods = {
        ...
        init: function (options) {
            ...
            var numMatches = 0;
            document.getElementById("foundPair").innerHTML = numMatches;
            var numSeconds = 0;
            var numMaxSeconds = opts.maxTime;
            document.getElementById("timeCounter").innerHTML = numMaxSeconds;
            ...
            var handleClick = function () {
                ...
                if (numTotalClicks == 0) {
                    ...
                    console.log("New timer:" + gameTimer);
                    existTimer = true;
                    gameOver = false;
                }
                // counts the clicks
                ...
                if (numClicks == 0) {
                    ...
                    if (tClass == selItemClass) {
                        ...
                        if (numMatches == itemsNum / 2) {
                            ...
                            existTimer = false;
                            console.log("machtimer");
                            gameOver = true;
                            // if game summary is set, adds the info to it and shows it.
                            if (opts.gameSummary) {
                                $('div#quizy-game-summary').children('div#gs-column1').html('Winner!');
            ...
            var hideItem = function (el) {
                ...
                switch (opts.animType) {
                    ...
                    case 'flip':
                        ...
                        break;
                    case 'scroll':
                        $('#' + topId).delay(delayShow).animate({height: 'toggle', opacity: 1}, opts.animSpeed,
                            function () {
                                removeInHTML(el);
                            });
                        break;
            ...
            var incTime = function () {
                if (timerReset) {
                    ...
                    numSeconds++;
                    console.log("Max time: " + numMaxSeconds);
                    console.log("Counter time: " + numSeconds);
                    document.getElementById("timeCounter").innerHTML = (numMaxSeconds - numSeconds);
                    if ((numMaxSeconds - numSeconds) <= 0) {
                        clearInterval(gameTimer);
                        existTimer = false;
                        console.log("timeover");
                        gameOver = true;

                        console.log($('div.' + itemsClass));
                        unbindClick($('div.' + itemsClass));

                        // if game summary is set, adds the info to it and shows it.
                        if (opts.gameSummary) {
                            $('div#quizy-game-summary').children('div#gs-column1').html('Loser! Time is over');
                            $('div#quizy-game-summary').children('div#gs-column2').html(numSeconds + '<br>' + opts.textSummaryTime);
                            $('div#quizy-game-summary').children('div#gs-column3').html(numTotalClicks + '<br>' + opts.textSummaryClicks);
                            $('div#quizy-game-summary').delay(2000).fadeIn(1000);
                        }
            ...
            if (opts.gameSummary) {
                ...
                gameEl.append('<div id="quizy-game-summary"><div class="gs-column" id="gs-column1"></div>' +
                    '<div class="gs-column" id="gs-column2"></div>' +
